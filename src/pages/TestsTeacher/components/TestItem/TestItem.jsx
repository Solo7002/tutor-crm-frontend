...
const TestItem = () => {
    return (
            ...
            <div
                data-property-1="Valid"
                data-size="Small"
                className="test-item-card"
            >
                <div className="test-item-content">
                    <div className="test-item-header">
                        <div className="test-item-title">Математика-1</div>
                    </div>
                    <div className="test-item-description">
                        Основи геометрії. Прямокутна система координат
                    </div>
