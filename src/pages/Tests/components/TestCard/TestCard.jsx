    ...
    return (
        ...
        >
            ...
            <div className="self-stretch justify-between items-end inline-flex">
                ...
                <div className="w-[152px] h-12 p-2 bg-white rounded-[40px] border border-[#8a48e6] justify-end items-center gap-5 flex">
                    <div className="text-[#8a48e6] text-[15px] font-bold font-['Nunito']">Виконати</div>
                    <div data-svg-wrapper>
