...
const TestCard = ({ test, onClick }) => {
    ...
    return (
        <div
            className={`relative w-full max-w-md p-4 rounded-3xl border flex-col justify-start items-start gap-4 inline-flex pattern-bg`}
            style={{
        ...
        >
            ...
            {/* Dates and Button */}
            <div className="self-stretch flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-0">
                ...
                {!isDone && (
                    <div
                        className="p-2 bg-white rounded-[40px] border justify-end items-center gap-5 flex cursor-pointer w-full sm:w-auto max-w-[152px]"
                        style={{ borderColor: buttonColor }}
                        onClick={onClick}
                    >
                        <div
                            className="text-[15px] font-bold font-['Nunito'] flex-grow text-center sm:text-left"
                            style={{ color: buttonColor }}
                        >
                            {t("Tests.TestStudentComponents.TestCard.completeButton")}
                        </div>
                        <div data-svg-wrapper className="cursor-pointer flex-shrink-0">
                ...
                {isDone && (
                    <div
                        className="h-12 px-4 py-2 rounded-[40px] justify-between items-center inline-flex cursor-pointer w-full sm:w-auto max-w-[160px]"
