...
const HometaskTeacher = () => {
  ...
  return (
    <div className="hometask-teacher-page pr-10">
      <HomeTaskCreateModal
      ...
      <div className="flex justify-between mt-8">
        ...
        <div className="w-[210px] stroke-purple-600 hover:stroke-white">
          <SecondaryButton onClick={() => setIsManagerPage(!isManagerPage)}>
            <div className="relative">
              ...
              <div className="ml-7">{isManagerPage ? "Перевірити завдання" : "Менеджер завдань"}</div>
            </div>
          </SecondaryButton>
        </div>
      </div>

      {
        isManagerPage ?
          <div>
            ...
            {hometasks.length > 0 && (
              <div className="flex flex-wrap gap-5 mt-5">
                {isBlockType ? (
                  <div
                    className="task-block-card relative w-[420px] h-[230px] p-4 rounded-3xl border border-[#e0e0e0] transition-colors duration-100 ease-in-out group hover:border-purple-600 cursor-pointer"
                    ...
                    <div className="w-full h-full relative rounded-3xl">
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <div className="flex justify-center">
                          <svg className="transition-transform duration-300 ease-in-out group-hover:scale-105" width="44" height="42" viewBox="0 0 44 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="text-[#120c38] text-[20px] font-normal font-['Mulish'] mt-5 transition-all duration-300 ease-in-out group-hover:scale-105 group-hover:font-semibold">
                          Додати завдання
                        </div>
                      </div>
                    </div>
                  ...
                  <div
                    className="task-block-card relative w-[640px] h-[160px] p-4 rounded-3xl border border-[#e0e0e0] transition-colors duration-100 ease-in-out group hover:border-purple-600 cursor-pointer"
                    style={{ backgroundImage: 'linear-gradient(to top right, white, transparent)' }}
                    onClick={() => { setIsModalOpened(true); setSelectedHometask(null); }}
                  >
                    <div className="w-full h-full relative rounded-3xl">
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <div className="w-full flex items-center justify-between">
                          ...
                          <div className="text-[#120c38] text-[20px] font-normal font-['Mulish'] ml-10 transition-all duration-300 ease-in-out group-hover:scale-105 group-hover:font-semibold">
                            Додати завдання
                          </div>
                        </div>
                      </div>
          ...
          :
          <div>
            <div className="w-full flex justify-between mt-7 mr-3">
              <div className="font-[Nunito] font-[700] text-2xl leading-none tracking-tighter align-middle text-[#120C38]">Останні завдання</div>
              <div
                className="font-[Nunito] font-bold text-[15px] leading-none tracking-tighter text-right align-middle underline decoration-solid decoration-0 underline-offset-0 text-[#8A48E6] cursor-pointer hover:text-[#6a36b5]"
            ...
            <div className="relative">
              <div
                className={`w-full flex mt-5 ${isExpanded ? 'flex-wrap gap-y-4' : 'overflow-x-auto hide-scrollbar py-1 pl-1 -ml-1'}`}
                id="scrollContainer"
              >
              ...
              {!isExpanded && (
                <div className="w-[217px] h-[174px] absolute right-0 top-0 bg-gradient-to-l from-[#f6eeff] to-[#f6eeff]/0" />
              )}
            </div>
