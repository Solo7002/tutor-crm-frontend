                    ...
                    <div className="self-stretch h-44 flex-col justify-start items-start gap-4 flex">
                        ...
                        <div className="h-20 flex-col justify-center items-end gap-1 flex">
                            <div className="self-stretch justify-start items-center gap-2 inline-flex">
                                ...
                                <div><span className="text-slate-400 text-base font-normal font-['Nunito']">Видано:<br /></span><span className="text-slate-900 text-base font-extrabold font-['Nunito']">{issuedDate}</span></div>
                            </div>
                            <div data-svg-wrapper>
                            ...
                            <div className="self-stretch justify-start items-center gap-2 inline-flex">
                                ...
                                <div><span className="text-slate-400 text-base font-normal font-['Nunito']">{status == 'done' ? 'Виконано' : 'Виконати до'}<br /></span><span className={` text-base font-extrabold  homework-status-${statusColors[status]} font-['Nunito']`}>{dueDate}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-48 flex-col justify-start items-start gap-2 inline-flex">
                        <div className="self-stretch justify-start items-center gap-2 inline-flex">
                            ...
                            <div>
                                ...
                                <span className="text-slate-900 text-base font-extrabold font-['Nunito']"> {issuedDate}</span>
                            </div>
                        </div>
                        <div className="self-stretch justify-start items-center gap-2 inline-flex">
                            <div data-svg-wrapper>
                            ...
                            <div>
                                ...
                                <span className={` text-base font-extrabold font-['Nunito'] homework-status-${statusColors[status]}`}>
                                    {dueDate}
                                </span>
                            </div>
                        </div>
