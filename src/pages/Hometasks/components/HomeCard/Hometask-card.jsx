...
export const StatusButton = ({ status, mark, maxmark, onClick, disabled = false, children, svg, className, ...props }) => {
    ...
    return (
        <button
            ...
            {...props}
        >
            <div className={`grow shrink basis-0 text-center text-base font-bold font-['Nunito']`}>{getText()}</div>
            ...
            <div className={`w-[420px] h-60 px-4 py-3 back-card bg-gradient-to-tr homework-status-${statusColors[status]} from-white to-emerald-30 rounded-3xl border  justify-start items-start gap-4 inline-flex overflow-hidden`}>
                <div className="w-48 flex-col justify-start items-start gap-2 inline-flex">
                    ...
                    <div className="self-stretch h-44 flex-col justify-start items-start gap-4 flex">
                        <div className={`self-stretch h-20 text-slate-900 text-xl font-normal font-['Nunito']`}>{title}</div>
                        <div className="h-20 flex-col justify-center items-end gap-1 flex">
                            <div className="self-stretch justify-start items-center gap-2 inline-flex">
                                ...
                                <div><span className="text-slate-400 text-base font-normal font-['Nunito']">Видано:<br /></span><span className="text-slate-900 font-bold font-['Nunito']">{issuedDate}</span></div>
                            </div>
                            <div data-svg-wrapper>
                            ...
                            <div className="self-stretch justify-start items-center gap-2 inline-flex">
                                ...
                                <div><span className="text-slate-400 text-base font-normal font-['Nunito']">{status == 'done' ? 'Виконано' : 'Виконати до'}<br /></span><span className={` text-base font-bold  homework-status-${statusColors[status]} font-['Nunito']`}>{dueDate}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="hometask-card">
            <div className={`w-[408px] h-[184px] p-4 back-card bg-gradient-to-tr from-white to-emerald-30 rounded-3xl border  flex-col justify-start items-start gap-3 inline-flex homework-status-${statusColors[status]}`}>
                <div className="self-stretch h-20 flex-col justify-start items-start gap-2 flex">
                    ...
                    <div className="self-stretch text-slate-900 text-xl font-normal font-['Nunito']">
                        {title}
                    </div>
                </div>
                <div className="self-stretch justify-between items-end inline-flex">
                    <div className="w-48 flex-col justify-start items-start gap-2 inline-flex">
                        <div className="self-stretch justify-start items-center gap-2 inline-flex">
                            ...
                            <div>
                                <span className="text-slate-400 font-['Nunito']">Видано:</span>
                                <span className="text-slate-900 font-['Nunito']"> {issuedDate}</span>
                            </div>
                        </div>
                        <div className="self-stretch justify-start items-center gap-2 inline-flex">
                            <div data-svg-wrapper>
                            ...
                            <div>
                                <span className="text-slate-400 text-base font-['Nunito']">{status == 'done' ? 'Виконано' : 'Виконати до'}: </span>
                                <span className={`text-base font-['Nunito'] homework-status-${statusColors[status]}`}>
                                    {dueDate}
                                </span>
                            </div>
                        </div>
