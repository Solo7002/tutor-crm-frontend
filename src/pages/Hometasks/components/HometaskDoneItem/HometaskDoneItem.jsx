...
import  "./HometaskDoneItem.css"
const HometaskDoneItem=({text,onClick,disabled=false,...props})=> {
    const [isHovered, setIsHovered] = useState(false);

    return (
        <div className="HometaskDoneItem">
...
export default HometaskDoneItem;