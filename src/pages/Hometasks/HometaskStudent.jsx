...
const HometaskStudent = () => {
  ...
  // Загрузка всех данных один раз при монтировании
  useEffect(() => {
    ...
    fetchInitialData();
  }, [studentId]); // Зависимость только от studentId

  // Фильтрация задач по предмету
  ...
  // Обновление отображаемых задач при смене предмета
  useEffect(() => {
  ...
  const handleButtonClick = (index) => {
    ...
    setSearchQuery(''); 
    switch (index) {
      case 0: setStatus("default"); break;
