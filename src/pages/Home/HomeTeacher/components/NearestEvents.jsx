...
const NearestEvents = ({ events }) => {
    return (
        <div className="bg-white rounded-[20px] shadow-md h-[25vh] sm:h-[25vh] overflow-y-auto events relative">
            {/* Header */}
            <h2
                                ...
                                <li key={index} className="mb-2">
                                    <div className="w-full mx-auto h-[50px] sm:h-[60px] relative">
                                        ...
                                        <Link to="/teacher/calendar">
                                            <div
                                                className="h-[28px] sm:h-[35px] px-2 sm:px-4 py-1 sm:py-2 right-[10px] top-[10px] sm:top-[12px] absolute rounded-[40px] border border-[#8a48e6] justify-center items-center gap-1 sm:gap-2.5 inline-flex cursor-pointer"
                                            >
