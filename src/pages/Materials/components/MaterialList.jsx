...
export default function MaterialList({ name, ext, img, onDownloadClick }) {
    return (
        <div className="w-full h-[74px] p-[15px] bg-white rounded-3xl border border-[#d7d7d7] transition-shadow duration-200 hover:shadow-[0_0_0_3px_#8A48E6] justify-start items-center gap-5 inline-flex">
            ...
            <div data-svg-wrapper className="downloadButton cursor-pointer" onClick={onDownloadClick}>
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
