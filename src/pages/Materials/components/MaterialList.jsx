...
export default function MaterialList({ name, ext, img }) {
    return (
        <div className="h-[74px] p-[15px] bg-white rounded-3xl border border-[#d7d7d7] justify-start items-center gap-5 inline-flex">
