...
export default function MaterialBlock({ name, ext, img, onDownloadClick, materialId = null, onDelete, onEdit, openAccessModalHandler }) {
    ...
    return (
        <div className="w-[244px] h-[234px] relative bg-white rounded-3xl outline outline-1 outline-[#d7d7d7] transition-shadow duration-200 hover:shadow-[0_0_0_3px_#8A48E6] hover:outline-none z-30">
            <img
                className="w-[244px] h-40 rounded-tl-3xl rounded-tr-3xl absolute top-0 left-0 object-cover"
                src={`${img ?? "/assets/materials/cover.png"}`}
                alt=""
            />
            <div className="self-stretch justify-between items-start inline-flex">
                <div className="h-11 left-[15px] bottom-6 absolute flex-col justify-start items-start gap-2.5 inline-flex">
                    {isEditing ? (
                        ...
                        <div className="self-stretch text-[#120c38] text-[15px] font-normal font-['Nunito']">
                ...
                {materialId && (
                    <div
                        className="left-[205px] top-[15px] absolute cursor-pointer"
                ...
                <div
                    className={`absolute top-0 w-full max-w-[244px] px-[9px] py-[15px] bg-white rounded-3xl shadow-[1px_1px_5px_0px_rgba(0,0,0,0.17)] inline-flex flex-col justify-start items-start gap-[15px] overflow-hidden transition-all duration-300 ${
                        isEditDelVisible
                ...
                <div
                    data-svg-wrapper
                    className="downloadButton right-[15px] bottom-6 absolute cursor-pointer -z-10"
                ...
                >
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            d="M12 25V27C12 27.5304 12.2107 28.0391 12.5858 28.4142C12.9609 28.7893 13.4696 29 14 29H26C26.5304 29 27.0391 28.7893 27.4142 28.4142C27.7893 28.0391 28 27.5304 28 27V25M15 19L20 24M20 24L25 19M20 24V12"
                            stroke="#8A48E6"
                            strokeWidth="2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
