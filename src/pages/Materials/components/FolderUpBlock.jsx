...
export default function FolderUpBlock({ onClick }) {
    return (
        <div className="w-[244px] h-[234px] relative bg-white rounded-3xl border border-[#d7d7d7] transition-shadow duration-200 hover:shadow-[0_0_0_3px_#8A48E6] flex-col justify-center items-center gap-[35px] inline-flex" onClick={onClick}>
